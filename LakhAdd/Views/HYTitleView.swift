...
protocol HYTitleViewDelegate : class {
    func titleView(_ titleView : HYTitleView, currentIndex : Int)
}
...
class HYTitleView: UIView {
    ...
    // MARK: 构造函数
    init(frame: CGRect, style : HYPageStyle, titles : [String]) {
        self.style = style
        self.titles = titles
...
extension HYTitleView : HYContentViewDelegate {
    func contentView(_ contentView: HYContentView, inIndex: Int) {
        // 1.记录最新的currentIndex
